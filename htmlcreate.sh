...
#   It can be used to create without spending a lot of time a new html template file into
...
function create() {
  if [[ "$file" = "-h" || "$file" = "--help" ]] ; then
    ...
    write_phrase "I can't create an unnamed file. Tell me the name." "4"
    read "file"
    create
  else
